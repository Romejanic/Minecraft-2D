package romejanic.engine.controls;
...
public class Xbox360Controller extends XboxController {
	...
	public static final int DPAD_UP = 4, DPAD_DOWN = 8, DPAD_LEFT = 16, DPAD_RIGHT = 32;
    ...
    public boolean equals (Object obj) {
            ...
            Xbox360Controller other = (Xbox360Controller)obj;
            if (controller == null) {
    ...
    static public class ControllerInput implements Input {
            ...
            private transient Xbox360Controller device;
            ...
            public Xbox360Controller getInputDevice () {
                    if (device != null) return device;
                    for (Controller controller : ControllerEnvironment.getDefaultEnvironment().getControllers()) {
                            if (!controller.getName().equals(controllerName)) continue;
                            device = new Xbox360Controller(controller);
                            return device;
                    }
                    return null;
            }
    ...
    static public List<XboxController> getJInputControllers () {
            ...
            for (Controller controller : ControllerEnvironment.getDefaultEnvironment().getControllers())
                    if (controller.getType() == Controller.Type.GAMEPAD) list.add(new Xbox360Controller(controller));
            return list;
    }
